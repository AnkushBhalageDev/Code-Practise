...
ListA = [1,2,11,3,25,54,5,6,7,8]

ListB = [3,4,5,6,9,1,54,2,25]
...
Input:["Ankush","kartik","kunal","banana","apple"]

Output:["banana","apple","Ankush","kunal","kartik"]

25️⃣ Remove Duplicate Characters and Keep Order

Input:"Ankush Bhalage"
...
29️⃣ .sort employeelist by last character of employee name

30️⃣ employee with second highest salary


31️⃣ Employee whose name starts with s

32️⃣sort by salary from each dept 

33️⃣group by salary (30-40,40-50)

34️⃣ find top 3 highest paid employee from each dept

35️⃣find dept with more than 2 employees

36️⃣find out maxaverage salary from dept

37️⃣max sal emp from each dept

38️⃣find max choosen subject from student list

39️⃣Input : int []arr1={1,3,4,1,5}

P1️⃣ : Stock daily price, buyonce and sell once in a week

P2️⃣ : Stock daily price, But mul and sell mul in a week
